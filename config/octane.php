...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These values are used when an explicit CLI option is not supplied to
    | `octane:start`. Keep worker counts bounded and recycle workers regularly
    | so retained application state cannot grow for the lifetime of a host.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Keep the HTTP package limit above the largest regular multipart upload.
    | Very large artifacts should use direct or object-storage uploads.
    |
    */
    ...
    'swoole' => [
        ...
        'options' => [
            'log_file' => env('SWOOLE_LOG_FILE', storage_path('logs/swoole_http.log')),
            'package_max_length' => (int) env('SWOOLE_PACKAGE_MAX_LENGTH', 32 * 1024 * 1024),
        ],
    ],
